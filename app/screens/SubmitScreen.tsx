            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.titleContainer}>
                    ...
                    <View style={styles.content}>
                        <Text style={styles.textRed}>HOÀN THÀNH BÀI KIỂM TRA</Text>
                        <Text style={styles.textTitle}>LƯU Ý MỘT CHÚT!</Text>
                        <Text style={styles.textDic}>Tuy rằng có vẻ bạn đang có đề kháng tốt nhưng cần quan tâm đến hệ vận động nhiều hơn nhé,
                            bởi sau tuổi 40,...</Text>
                        <Text style={styles.textInfo}>Điền thông tin bên dưới để xem đầy đủ
                            kết quả và nhận ngay Voucher ưu đãi lên đến 100.000đ từ Anlene.</Text>
                    </View>
                    {/* Form */}
                    <View style={styles.form}>
                        {/* Họ tên */}
                        <View><Text style={styles.label}>Họ tên:<Text style={styles.star}>*</Text></Text>
                            <TextInput
                            ...
                            />{isFullNameError && <Text style={styles.errorText}>Vui lòng nhập họ tên</Text>}</View>
                        {/* Số điện thoại */}
                        <View>
                            ...
                            />
                            {isPhoneError && <Text style={styles.errorText}>Vui lòng nhập số điện thoại</Text>}
                        </View>
                        {/* Email */}
                        <View>
